...
export const Context=createContext({
    items:[],
    addItem:({id,date,project,taskGroup,task,issue,activity,fromTime,toTime,workingHours,billingHours,description,taskStatus})=>{},
    setItem:({})=>{},
    deleteItem:({id})=>{},
    updateItem:({id,date,project,taskGroup,task,issue,activity,fromTime,toTime,workingHours,billingHours,description,taskStatus})=>{},
})
